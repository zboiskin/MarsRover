...
//define the pin numbers for each bulb color in the LEDs
const int bluePin = 11;
const int redPin = 12;
const int greenPin = 13;

/* Calibrate brightness */
//these are set to correctly add the right amount of bulb brightness for specific colors like orange and yellow
#define R_OFFSET 1.0
#define G_OFFSET 0.25
#define B_OFFSET 0.45

void setup() {
	SoftPWMBegin(); //initialize the software-based PWM on all pins
}
